layui.define('grid', function (exports) {
    var Grid = layui.grid,$ = layui.jquery;
    var TreeGrid = {
        config: Grid.config,
            ...
            var HELPER = {
                ...
                expanded: function (flag, id) {
                    ...
                    if (id != undefined) {
                        ...
                        // tr = grid.elem.find('.grid-body tr.treegrid-' + name);
                ...
                cellapsed: function (flag, id) {
                    ...
                    if (id != undefined) {
                        ...
                        // tr = grid.elem.find('.grid-body tbody tr.treegrid-' + name);
                ...
                onExpand: function () {
                    ...
                    if (tr.hasClass('treegrid-expanded')) {
                        ...
                        // HELPER.cellapsed(false, name);
                    } else {
                        HELPER.expanded(false, id);
                        // HELPER.expanded(false, name);
                    }
