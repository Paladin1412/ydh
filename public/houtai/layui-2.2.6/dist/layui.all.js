...
var I18nfun = {
    lan: "cn", isInit: false, lanObj: {}, initLanObj: function (_lan) {
        if ("id" == _lan) {
            this.lanObj = I18n_id
        } else {
            if ("en" == _lan) {
    ...
    }, changeLan: function (_lan) {
        this.lan = _lan;
        this.initLanObj(_lan)
    }, get: function (key) {
        if (!this.isInit) {
            this.changeLan("cn");
            this.isInit = true
        }
        return this.lanObj[key]
    }, getLang: function () {
        return dataStore.get('current_lan') || this.lan
    }, getEnOrCn: function () {
        return (dataStore.get('current_lan') || this.lan) == "cn" ? "cn" : "en"
    }
};
;!function (e) {
    "use strict";
...
layui.define(function (e) {
    ...
    u.prototype.type = function () {
        ...
        a.layout = "object" == typeof a.layout ? a.layout : ["prev", "page", "next"], a.count = 0 | a.count, a.curr = 0 | a.curr || 1, a.limits = "object" == typeof a.limits ? a.limits : [10, 20, 30, 40, 50], a.limit = 0 | a.limit || 10, a.pages = Math.ceil(a.count / a.limit) || 1, a.curr > a.pages && (a.curr = a.pages), t < 0 ? t = 1 : t > a.pages && (t = a.pages), a.prev = "prev" in a ? a.prev : (I18nfun.getEnOrCn() == 'cn' ? '&#x4E0A;&#x4E00;&#x9875;' : 'prev'), a.next = "next" in a ? a.next : (I18nfun.getEnOrCn() == 'cn' ? '&#x4E0B;&#x4E00;&#x9875;' : 'next');
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1, i = {
            ...
            count: '<span class="layui-laypage-count"> ' + a.curr + '/' + a.count + " </span>",
            limit: function () {
            ...
            skip: function () {
                return ['<span class="layui-laypage-skip">', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '<button type="button" class="layui-laypage-btn">' + 'GO' + '</button>', "</span>"].join("")
            }()
        };
...
!function () {
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function () {
        ...
        if (l.year < d[0] && (l.year = d[0], r.hint("最低只能支持到公元" + d[0] + "年")), l.year > d[1] && (l.year = d[1], r.hint("最高只能支持到公元" + d[1] + "年")), r.firstDate || (r.firstDate = w.extend({}, l)), c.setFullYear(l.year, l.month, 1), t = c.getDay(), a = n.getEndDate(l.month || 12, l.year), i = n.getEndDate(l.month + 1, l.year), w.each(y, function (e, n) {
            ...
            }), w(f[0]).attr("lay-ym", l.year + "-" + (l.month + 1)), w(f[1]).attr("lay-ym", l.year + "-" + (l.month + 1)), "cn" === I18nfun.getEnOrCn() /*s.lang*/ ? (w(f[0]).attr("lay-type", "year").html(l.year + "年"), w(f[1]).attr("lay-type", "month").html(l.month + 1 + "月")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]), w(f[1]).attr("lay-type", "year").html(l.year)), u && (s.range && (e ? r.endDate = r.endDate || {
        ...
        var n = this, a = n.config, i = a.dateTime, r = n.lang(),
            ...
            f = "cn" === I18nfun.getEnOrCn()/*a.lang*/, p = f ? "年" : "", T = n.listYM[t] || {},
...
layui.define("layer", function (e) {
    ...
    c.prototype.set = function (e) {
        ...
        var n = this, c = t(r + function () {
            ...
            select: function () {
                var i = I18nfun.get('layui_select');
                var e, a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                ...
                f.each(function (e, l) {
                    ...
                    var v = "string" == typeof r.attr("lay-search"),
                        p = (y ? t(y).attr('placeholder') : 0) || (y ? y.value ? i : y.innerHTML || i : i),
